...
public class Doacao {
    ...
    private List<OrgaoDoado> orgaos;
    ...
    public String getResponsavelFamiliar() { return responsavelFamiliar; }
    ...
    public LocalDateTime getDataEntrevista() { return dataEntrevista; }
    ...
    public List<OrgaoDoado> getOrgaos() { return orgaos; }
    public void setOrgaos(List<OrgaoDoado> orgaos) { this.orgaos = orgaos; }
