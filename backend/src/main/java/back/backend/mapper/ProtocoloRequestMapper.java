...
public interface ProtocoloRequestMapper {
    ...
    @Mapping(target = "testeClinico1Validado", ignore = true)
    @Mapping(target = "dataValidacaoTesteClinico1", ignore = true)
    @Mapping(target = "testeClinico2Validado", ignore = true)
    @Mapping(target = "dataValidacaoTesteClinico2", ignore = true)
    @Mapping(target = "testesComplementaresValidados", ignore = true)
    @Mapping(target = "dataValidacaoTesteComplementar", ignore = true)
    @Mapping(target = "apneiaValidada", ignore = true)
    @Mapping(target = "dataValidacaoApneia", ignore = true)
    @Mapping(target = "validadosPor", ignore = true)
    @Mapping(target = "dataValidacaoGeral", ignore = true)
