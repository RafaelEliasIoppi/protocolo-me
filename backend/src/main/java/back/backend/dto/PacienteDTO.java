...
public class PacienteDTO {
    ...
    public String getObservacoesEntrevistaFamiliar() {
        return observacoesEntrevistaFamiliar;
    }

    public void setObservacoesEntrevistaFamiliar(String observacoesEntrevistaFamiliar) {
        this.observacoesEntrevistaFamiliar = observacoesEntrevistaFamiliar;
    }

    public LocalDateTime getDataEntrevistaFamiliar() {
        return dataEntrevistaFamiliar;
    }

    public void setDataEntrevistaFamiliar(LocalDateTime dataEntrevistaFamiliar) {
        this.dataEntrevistaFamiliar = dataEntrevistaFamiliar;
    }
    ...
    public List<ProtocoloResumoDTO> getProtocolosME() {
        return protocolosME;
    }

    public void setProtocolosME(List<ProtocoloResumoDTO> protocolosME) {
